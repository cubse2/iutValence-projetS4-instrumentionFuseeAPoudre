...
ConcretSpeakerController::ConcretSpeakerController(int speakerPin)
{
	this->speakerPin = speakerPin;
}

void ConcretSpeakerController::ring(int note, int noteDuration)
{
...
void ConcretSpeakerController::ringOfStart()
{
  int notes[] = {NOTE_C4, NOTE_G3, NOTE_G3, NOTE_A3, NOTE_G3};
...
void ConcretSpeakerController::ringOfEnd()
{
  int notes[] = {NOTE_E5, NOTE_E5, NOTE_E5, NOTE_E5, NOTE_E5};
  int noteDurations[] = {6,6,6,6,6};
  for(int melody = 0; melody < sizeof(notes); melody++)
  {
    ring(notes[melody], noteDurations[melody]);
  }
